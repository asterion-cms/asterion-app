...
class Installation_Ui extends Ui
{
    ...
    public static function renderLanguages()
    {
        ...
        if (count($languages) > 0) {
            return '<div class="configuration">
                        <div class="message">
                            <p>You have already installed languages in your website.</p>
                            <p>Please use the administrator to update them.</p>
                        </div>
                    </div>';
        } else {
            return '<div class="configuration">
                        ...
                        <p>We already have the translations for the administration area for certain languages :</p>
                        ' . Language_Form::createFormBasic() . '
                        <p>Or, you can choose from these other languages and translate yourself :</p>
    ...
    public static function renderLanguagesVerification($languageCodes)
    {
        ...
        $fields = FormField::show('hidden', ['name' => 'langs_verified', 'value' => true]);
        return '<div class="configuration">
                    ...
                    '.((Session::get('languages_creation_admin_translations') == true) ? '
                    <p>These languages will be translated in the administration area</p>
                    ' : '').'
                    <div class="buttons_center">
