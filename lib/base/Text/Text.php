...
class Text
{
    ...
    /**
     * Format a value into a simple two decimal number.
     */
    ...
    /**
     * Format a microtime into a readable form.
     */
    public static function formatMicrotime($microtime)
    {
        return number_format(floatval($microtime) * 1000, 2, ',', '') . 'ms';
    }
    ...
    /**
     * Function to generate a small readable password.
     * Used when a user wants to reset it.
     */
    public static function generateSmallPassword()
    {
